...
ax.set_yscale('log')
plt.savefig('./images/coasts/LSTMlearningcurve.png', dpi=600, bbox_inches='tight')

#TODO: Save the model architecture
from keras.utils import plot_model

plot_model(regressor, to_file='./images/coasts/model_architecture/LSTMsample.png', show_shapes=True)
...
dataset_valid.plot(label='True Sea Level', figsize=(15,5))
...
plt.title('LSTM model 14-day forecasts with 60-day timesteps of sea water levels')
plt.legend(loc="upper left")
plt.savefig('./images/coastal/LSTM_sample_validationdata.png', dpi=600)
...
dataset_test.plot(label="True Sea Level", figsize=(15,5))
...
plt.title('LSTM model 14-day forecasts with 60-day timesteps of sea water levels')
plt.legend(loc='upper left')
plt.savefig('./images/sampleanalysis/LSTM_sample_testdata.png', dpi=600)
...
forecast_predictions_xr.plot(label="14th day predicted sea level")
