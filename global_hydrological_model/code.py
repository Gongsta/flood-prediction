#While the code is not written out yet, it can be worthwhile to write how you would want to structure the logic in your code
#for real time forecasting

"""
1. Train the model per basin for every basin in the world. We can run a for loop or compute it in parallel
