...
import xarray as xr
glofas = xr.open_mfdataset('/Volumes/Seagate Backup Plus Drive/data/'+ str(year) +'/CEMS_ECMWF_dis24_*_glofas_v2.1.nc', combine='by_coords')
        ...
        if day < 10:
            ...
            try:
                glofas = xr.open_dataset(
                    '/Volumes/Seagate Backup Plus Drive/data/' + str(year) + '/CEMS_ECMWF_dis24_' + str(month) + str(
                        day) + '_glofas_v2.1.nc')
