...
#I've realized that plotting with the data on the local disk is so much faster
import sys
...
glofas_masked['dis24'].isel(time=1).plot(ax=axes[0])
glofas_masked['dis24'].sel(time='2002-08-16').plot(ax=axes[1])
